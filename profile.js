...
if (url.indexOf(profile) != -1) {
  ...
  obj.userInfo.svip = 1;
  obj.userInfo.verified_reason = 'JAY';
  obj.userInfo.statuses_count = 0;
  obj.userInfo.orange_v = 'JAY';
  ...
  if (obj.userInfo.infoList[0].actionlog.ext != 'name:verified') {
    ...
    obj.userInfo.infoList[0].desc = 'JAY';
  }
...
if (url.indexOf(comments) != -1) {
  ...
  obj.user.svip = 1;
  obj.user.verified_reason = 'JAY';
  obj.user.statuses_count = 0;
  obj.user.orange_v = 'JAY';
